...
class Net(nn.Module):
    def __init__(self, n_channels=3, kernel_size=3, num_classes=10):
        ...
        self.conv1 = nn.Conv3d(
            n_channels, 32, kernel_size=3, stride=1, padding=1, bias=False
        )
        ...
        self.conv6 = nn.Conv3d(128, 256, kernel_size=3, stride=1, padding=1, bias=False)
        self.norm6 = nn.BatchNorm3d(256)

        self.conv7 = nn.Conv3d(256, 256, kernel_size=3, stride=1, padding=1, bias=False)
        self.norm7 = nn.BatchNorm3d(256)
        self.conv8 = nn.Conv3d(256, 512, kernel_size=3, stride=1, padding=1, bias=False)
        self.norm8 = nn.BatchNorm3d(512)
        self.upconv1 = nn.ConvTranspose3d(512, 512, kernel_size=2, stride=2)

        self.conv9 = nn.Conv3d(768, 256, kernel_size=3, stride=1, padding=1, bias=False)
        self.norm9 = nn.BatchNorm3d(256)
        ...
        self.conv11 = nn.Conv3d(
            384, 128, kernel_size=3, stride=1, padding=1, bias=False
        )
        self.norm11 = nn.BatchNorm3d(128)
        self.conv12 = nn.Conv3d(
            128, 128, kernel_size=3, stride=1, padding=1, bias=False
        )
        self.norm12 = nn.BatchNorm3d(128)
        self.upconv3 = nn.ConvTranspose3d(128, 128, kernel_size=2, stride=2)

        self.conv13 = nn.Conv3d(192, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.norm13 = nn.BatchNorm3d(64)
        self.conv14 = nn.Conv3d(64, 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.norm14 = nn.BatchNorm3d(64)
        self.conv_out = nn.Conv3d(64, num_classes, kernel_size=1, stride=1, bias=True)
