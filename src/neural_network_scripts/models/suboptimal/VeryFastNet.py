...
class Net(nn.Module):
    def __init__(self, n_channels=3, growth=24, compress_targ=32, num_classes=10):
        ...
        self.conv_out = nn.Conv3d(
            n_channels + growth + (2 * growth) + 2 * (self.compress_targh),
            num_classes,
            kernel_size=1,
            stride=1,
            bias=True,
    ...
    def forward(self, x, verbose=False):
        ...
        """
        x = torch.cat(
            [ori, send0, send1, send2, send3], dim=1
