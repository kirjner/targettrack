...
class Net(nn.Module):
    def __init__(self, n_channels=3, kernel_size=3, num_classes=10):
        ...
        self.conv13 = nn.Conv3d(
            192, 128, kernel_size=3, stride=1, padding=1, bias=False
        )
        self.norm13 = nn.BatchNorm3d(128)

        self.conv_out = nn.Conv3d(128, num_classes, kernel_size=1, stride=1, bias=True)
