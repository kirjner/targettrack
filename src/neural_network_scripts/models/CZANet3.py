...
class ASPP(nn.Module):
    def __init__(self, in_channels, mid_channels, out_channels, atrous_rates):
        ...
        self.compressionconv = nn.Conv3d(
            (len(atrous_rates) + 1) * mid_channels, out_channels, 1, bias=False
        )
...
class Net(nn.Module):
    def __init__(
        ...
        self.aspp2 = ASPP(
            n_filt_in,
            mid_channels=n_filt,
            out_channels=2 * n_filt,
            atrous_rates=((3, 3, 1), (6, 6, 2), (9, 9, 3)),
        )
        self.compressionaspp2conv = nn.Conv3d(
            2 * n_filt, compress_targ, kernel_size=1, stride=1, bias=False
        )
        ...
        self.aspp3 = ASPP(
            ...
            mid_channels=n_filt,
            out_channels=2 * n_filt,
            atrous_rates=((3, 3, 1), (6, 6, 1), (9, 9, 2)),
        )
