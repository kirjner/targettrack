...
def deformation_volume(mask, fr, target_pred_mask_i, target_fr_i, scale):
    ...
    pts_train, pts_train_trans, pts_target = get_pts_from_masksJV(
                ...
                if len(label_pts) > 2:
                    ...
                    for init_denom in range(5, 100, 5):
                        try:
                            ...
                            mask_warped[valid_points[:, 0], valid_points[:, 1], z] = (
                                label
                            )
                            break
                        except:
